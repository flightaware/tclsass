# Makefile.in --
#
#	This file is a Makefile for libsass TEA Extension.  If it has the name
...
PKG_SOURCES	=  tclsass.c
PKG_OBJECTS	=  tclsass.o
...
INCLUDES	=  -I../libsass -I"/usr/local/include/tcl8.6"
#INCLUDES	=  -I../libsass -I"/usr/local/include/tcl8.6" @TK_INCLUDES@ @TK_XINCLUDES@
